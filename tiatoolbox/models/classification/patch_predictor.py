...
class CNNPatchPredictor:
    ...
    def merge_predictions(
        ...
        Args:
            ...
            output (list): output generated by the model.
        ...
        # get shape of canvas at desired resolution
        ...
        if "probabilities" not in output.keys():
            ...
            output = np.zeros(list(output_shape) + [num_class], dtype=np.float32)
